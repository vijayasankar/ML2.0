...
// Entry Points
// ------------------------------------
// const APP_ENTRY = ['babel-polyfill', project.paths.client('main.js')] /* does not work on IE */
...
// Bundle Output
// ------------------------------------
// TODO: make providerportal directory configurable
// ------------------------------------
webpackConfig.output = {
  filename   : `[name].[${project.compiler_hash_type}].js`,
  path       : project.paths.dist(),
  publicPath : project.compiler_public_path + 'providerportal/'
}
  ...
  webpackConfig.plugins.push(
    new BrowserSyncPlugin(
      // BrowserSync options
      {
        ...
        proxy: `http://${project.server_host}:${project.server_port}`,
        open: false
      },
      // plugin options
      {
