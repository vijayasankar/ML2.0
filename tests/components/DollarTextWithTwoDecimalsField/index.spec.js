...
import DollarTextWithTwoDecimalsField from 'components/DollarTextWithTwoDecimalsField'
import ReduxFormStub from '../../ReduxFormStub'
import { render, mount, shallow } from 'enzyme'


describe('(Component) DollarTextWithTwoDecimalsField, Instantiate', () => {
  let component

  beforeEach(() => {
    component = new DollarTextWithTwoDecimalsField()
    component.props = {}
  })
...
describe('(Component) DollarTextWithTwoDecimalsField, Shallow', () => {
  let component
  ...
  beforeEach(() => {
    component = shallow(<DollarTextWithTwoDecimalsField {...initProps}/>)
  })
...
describe('(Component) DollarTextWithTwoDecimalsField, Mount', () => {
  let component

  const spyComponentDidUpdate = sinon.spy(DollarTextWithTwoDecimalsField.prototype, 'componentDidUpdate')
  ...
  beforeEach(() => {
    component = mount(
        <ReduxFormStub>
        <DollarTextWithTwoDecimalsField {...initProps} />
      </ReduxFormStub>
    )
  })
  ...
  it('should call componentDidUpdate and not change props', () => {
    ...
    expect(DollarTextWithTwoDecimalsField.prototype.componentDidUpdate.callCount).to.equal(1)
  })
