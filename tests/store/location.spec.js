...
describe('(Internal Module) Location', () => {
  ...
  describe('(Action Creator) locationChange', () => {
    ...
    it('Should default the "payload" property to "/providerportal/" if not provided.', () => {
      expect(locationChange()).to.have.property('payload', '/providerportal/')
    })
  })
  ...
  describe('(Specialized Action Creator) updateLocation', () => {
    ...
    it('Should call dispatch exactly once.', () => {
      updateLocation({ dispatch: _dispatchSpy })('/providerportal/')
