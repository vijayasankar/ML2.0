...
export class RequestPaymentDeclaration extends React.Component {
  render() {
    return (
...
RequestPaymentDeclaration.propTypes = {
  cssName: React.PropTypes.string
}

RequestPaymentDeclaration.defaultProps = {
  // cssName: 'declaration'
}

export default reduxForm({form: 'requestPayment'})(RequestPaymentDeclaration)
